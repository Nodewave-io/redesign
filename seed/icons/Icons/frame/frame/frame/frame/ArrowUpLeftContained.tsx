...
const ArrowUpLeftContainedInner = forwardRef<SVGSVGElement, IconProps>(
  function ArrowUpLeftContained({ size = 24, color = 'currentColor', ...props }: IconProps, ref) {
    return (
...
export const ArrowUpLeftContained = memo(ArrowUpLeftContainedInner)
ArrowUpLeftContained.displayName = 'ArrowUpLeftContained'