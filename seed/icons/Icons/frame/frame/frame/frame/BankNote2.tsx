...
const BankNote2Inner = forwardRef<SVGSVGElement, IconProps>(
  function BankNote2({ size = 24, color = 'currentColor', ...props }: IconProps, ref) {
    return (
...
export const BankNote2 = memo(BankNote2Inner)
