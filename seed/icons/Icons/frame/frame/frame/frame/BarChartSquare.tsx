...
const BarChartSquareInner = forwardRef<SVGSVGElement, IconProps>(
  function BarChartSquare({ size = 24, color = 'currentColor', ...props }: IconProps, ref) {
    return (
...
export const BarChartSquare = memo(BarChartSquareInner)
