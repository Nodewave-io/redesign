...
const BarChartSquare3Inner = forwardRef<SVGSVGElement, IconProps>(
  function BarChartSquare3({ size = 24, color = 'currentColor', ...props }: IconProps, ref) {
    return (
...
export const BarChartSquare3 = memo(BarChartSquare3Inner)
BarChartSquare3.displayName = 'BarChartSquare3'