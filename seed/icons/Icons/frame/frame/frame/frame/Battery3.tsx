...
const Battery3Inner = forwardRef<SVGSVGElement, IconProps>(
  function Battery3({ size = 24, color = 'currentColor', ...props }: IconProps, ref) {
    return (
...
export const Battery3 = memo(Battery3Inner)
