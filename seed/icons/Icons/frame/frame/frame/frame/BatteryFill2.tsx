...
const BatteryFill2Inner = forwardRef<SVGSVGElement, IconProps>(
  function BatteryFill2({ size = 24, color = 'currentColor', ...props }: IconProps, ref) {
    return (
...
export const BatteryFill2 = memo(BatteryFill2Inner)
BatteryFill2.displayName = 'BatteryFill2'