...
const Calculator3Inner = forwardRef<SVGSVGElement, IconProps>(
  function Calculator3({ size = 24, color = 'currentColor', ...props }: IconProps, ref) {
    return (
...
export const Calculator3 = memo(Calculator3Inner)
