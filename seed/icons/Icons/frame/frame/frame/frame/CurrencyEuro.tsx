...
const CurrencyEuroInner = forwardRef<SVGSVGElement, IconProps>(
  function CurrencyEuro({ size = 24, color = 'currentColor', ...props }: IconProps, ref) {
    return (
...
export const CurrencyEuro = memo(CurrencyEuroInner)
