...
const EditContainedInner = forwardRef<SVGSVGElement, IconProps>(
  function EditContained({ size = 24, color = 'currentColor', ...props }: IconProps, ref) {
    return (
...
export const EditContained = memo(EditContainedInner)
EditContained.displayName = 'EditContained'