...
const File6Inner = forwardRef<SVGSVGElement, IconProps>(
  function File6({ size = 24, color = 'currentColor', ...props }: IconProps, ref) {
    return (
...
export const File6 = memo(File6Inner)
File6.displayName = 'File6'