...
const Globe5Inner = forwardRef<SVGSVGElement, IconProps>(
  function Globe5({ size = 24, color = 'currentColor', ...props }: IconProps, ref) {
    return (
...
export const Globe5 = memo(Globe5Inner)
Globe5.displayName = 'Globe5'