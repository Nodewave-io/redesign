...
const ImageDownInner = forwardRef<SVGSVGElement, IconProps>(
  function ImageDown({ size = 24, color = 'currentColor', ...props }: IconProps, ref) {
    return (
...
export const ImageDown = memo(ImageDownInner)
