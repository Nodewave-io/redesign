...
const Luggage2Inner = forwardRef<SVGSVGElement, IconProps>(
  function Luggage2({ size = 24, color = 'currentColor', ...props }: IconProps, ref) {
    return (
...
export const Luggage2 = memo(Luggage2Inner)
Luggage2.displayName = 'Luggage2'