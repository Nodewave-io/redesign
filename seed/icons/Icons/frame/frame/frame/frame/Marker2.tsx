...
const Marker2Inner = forwardRef<SVGSVGElement, IconProps>(
  function Marker2({ size = 24, color = 'currentColor', ...props }: IconProps, ref) {
    return (
...
export const Marker2 = memo(Marker2Inner)
Marker2.displayName = 'Marker2'