...
const MessageAlertPlusInner = forwardRef<SVGSVGElement, IconProps>(
  function MessageAlertPlus({ size = 24, color = 'currentColor', ...props }: IconProps, ref) {
    return (
...
export const MessageAlertPlus = memo(MessageAlertPlusInner)
MessageAlertPlus.displayName = 'MessageAlertPlus'