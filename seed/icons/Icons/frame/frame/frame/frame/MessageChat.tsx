...
const MessageChatInner = forwardRef<SVGSVGElement, IconProps>(
  function MessageChat({ size = 24, color = 'currentColor', ...props }: IconProps, ref) {
    return (
...
export const MessageChat = memo(MessageChatInner)
