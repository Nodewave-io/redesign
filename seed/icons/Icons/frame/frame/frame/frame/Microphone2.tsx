...
const Microphone2Inner = forwardRef<SVGSVGElement, IconProps>(
  function Microphone2({ size = 24, color = 'currentColor', ...props }: IconProps, ref) {
    return (
...
export const Microphone2 = memo(Microphone2Inner)
