...
const NotificationSquare2Inner = forwardRef<SVGSVGElement, IconProps>(
  function NotificationSquare2({ size = 24, color = 'currentColor', ...props }: IconProps, ref) {
    return (
...
export const NotificationSquare2 = memo(NotificationSquare2Inner)
NotificationSquare2.displayName = 'NotificationSquare2'