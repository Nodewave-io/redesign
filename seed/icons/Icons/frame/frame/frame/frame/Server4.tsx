...
const Server4Inner = forwardRef<SVGSVGElement, IconProps>(
  function Server4({ size = 24, color = 'currentColor', ...props }: IconProps, ref) {
    return (
...
export const Server4 = memo(Server4Inner)
Server4.displayName = 'Server4'