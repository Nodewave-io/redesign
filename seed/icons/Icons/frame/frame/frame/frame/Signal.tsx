...
const SignalInner = forwardRef<SVGSVGElement, IconProps>(
  function Signal({ size = 24, color = 'currentColor', ...props }: IconProps, ref) {
    return (
...
export const Signal = memo(SignalInner)
