...
const SuperscriptInner = forwardRef<SVGSVGElement, IconProps>(
  function Superscript({ size = 24, color = 'currentColor', ...props }: IconProps, ref) {
    return (
...
export const Superscript = memo(SuperscriptInner)
