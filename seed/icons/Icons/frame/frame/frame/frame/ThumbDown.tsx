...
const ThumbDownInner = forwardRef<SVGSVGElement, IconProps>(
  function ThumbDown({ size = 24, color = 'currentColor', ...props }: IconProps, ref) {
    return (
...
export const ThumbDown = memo(ThumbDownInner)
