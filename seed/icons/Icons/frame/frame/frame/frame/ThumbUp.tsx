...
const ThumbUpInner = forwardRef<SVGSVGElement, IconProps>(
  function ThumbUp({ size = 24, color = 'currentColor', ...props }: IconProps, ref) {
    return (
...
export const ThumbUp = memo(ThumbUpInner)
