...
const TicketInner = forwardRef<SVGSVGElement, IconProps>(
  function Ticket({ size = 24, color = 'currentColor', ...props }: IconProps, ref) {
    return (
...
export const Ticket = memo(TicketInner)
