...
const Trash2Inner = forwardRef<SVGSVGElement, IconProps>(
  function Trash2({ size = 24, color = 'currentColor', ...props }: IconProps, ref) {
    return (
...
export const Trash2 = memo(Trash2Inner)
