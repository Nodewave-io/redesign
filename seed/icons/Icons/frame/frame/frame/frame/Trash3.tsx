...
const Trash3Inner = forwardRef<SVGSVGElement, IconProps>(
  function Trash3({ size = 24, color = 'currentColor', ...props }: IconProps, ref) {
    return (
...
export const Trash3 = memo(Trash3Inner)
