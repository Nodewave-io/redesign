...
const Trash4Inner = forwardRef<SVGSVGElement, IconProps>(
  function Trash4({ size = 24, color = 'currentColor', ...props }: IconProps, ref) {
    return (
...
export const Trash4 = memo(Trash4Inner)
Trash4.displayName = 'Trash4'