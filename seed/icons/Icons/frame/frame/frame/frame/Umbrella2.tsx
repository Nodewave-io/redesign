...
const Umbrella2Inner = forwardRef<SVGSVGElement, IconProps>(
  function Umbrella2({ size = 24, color = 'currentColor', ...props }: IconProps, ref) {
    return (
...
export const Umbrella2 = memo(Umbrella2Inner)
