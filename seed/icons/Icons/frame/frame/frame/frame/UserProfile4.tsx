...
const UserProfile4Inner = forwardRef<SVGSVGElement, IconProps>(
  function UserProfile4({ size = 24, color = 'currentColor', ...props }: IconProps, ref) {
    return (
...
export const UserProfile4 = memo(UserProfile4Inner)
UserProfile4.displayName = 'UserProfile4'