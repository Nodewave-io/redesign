...
const WebcamInner = forwardRef<SVGSVGElement, IconProps>(
  function Webcam({ size = 24, color = 'currentColor', ...props }: IconProps, ref) {
    return (
...
export const Webcam = memo(WebcamInner)
